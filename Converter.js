...
var Converter = function () {
    ...
    /**
     * @var string Id of randomize text input field.
     */
    var randomizeTextInputId = "randomize-checkbox";
     ...
     */
    this.getUsedTextField = function () {
        return document.getElementById(usedTextInputId);
    };

    /**
     * @return DOM-object Font size input field.
     */
    this.getFontSizeField = function () {
        return document.getElementById(fontSizeInputId);
    };

    /**
     * @return DOM-object Background color input field.
     */
    this.getBackgroundColorField = function () {
        return document.getElementById(backgroundColorInputId);
    };

    /**
     * @retrn DOM-object Background transparent input field.
     */
    this.getBackgroundTransparentField = function () {
        return document.getElementById(backgroundTransparentInputId);
    };

    /**
     * @retrn DOM-object Background transparent input field.
     */
    this.getRandomizeTextField = function () {
        return document.getElementById(randomizeTextInputId);
    };
    ...
    this.getCreateButton = function () {
        return document.getElementById(createButtonId);
    };
     ...
     */
    this.getUsedText = function () {
        return _this.getUsedTextField().value;
    };
    ...
    this.getFontSize = function () {
        return _this.getFontSizeField().value;
    };
    ...
    this.getBackgroundColor = function () {
        return (_this.getBackgroundTransparent() == true) ? "rgba(0,0,0,0)" : _this.getBackgroundColorField().value;
    };

    /**
     * @return bool Background transparent.
     */
    this.getBackgroundTransparent = function () {
        return _this.getBackgroundTransparentField().checked;
    };

    /**
     * @return bool Text randomized.
     */
    this.getRandomizeTextFieldValue = function () {
        return _this.getRandomizeTextField().checked;
    };
    ...
    var getNextUsedChar = function () {
        ...
        return (_this.getRandomizeTextFieldValue() == true) ? result : str;
     ...
     */
    var setCanvasWidth = function (val) {
        return getCanvas().width = canvasWidth = val * 1;
    };
     ...
     */
    var setCanvasHeight = function (val) {
        return getCanvas().height = canvasHeight = val * 1;
    };

    /**
     * @return integer Used text with.
     */
    var getUsedTextWidth = function () {
     ...
     */
    var setUsedTextWidth = function (val) {
        return usedTextWidth = val * 1;
    };

    /**
     * @return integer Used text height.
     */
    var getUsedTextHeight = function () {
     ...
     */
    var setUsedTextHeight = function (val) {
        return usedTextHeight = val * 1;
    };
